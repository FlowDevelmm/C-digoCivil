...
export default function CapitulosScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Stack.Screen options={{ title: 'Capítulos', headerStyle: { backgroundColor: colors.background, elevation: 0, shadowOpacity: 0, borderBottomWidth: 0 }, headerTintColor: colors.text }} />
      <FlatList
          ...
          <Link href={{ pathname: "/codigo/CapituloDetail", params: { livroIndex, tituloIndex, capituloIndex } }} asChild>
            <TouchableOpacity style={styles.card}>
              <View style={styles.cardContent}>
                <Text style={styles.romanNumeral}>CAPÍTULO {toRoman(capituloIndex + 1)}</Text>
